...
:::: {.column width="40%"}
::: fragment
3. en repassant à une composition
$$
...
::: fragment
4. en faisant une **correction multiplicative** ^[et une clôture si besoin]:
...
\begin{align*}
 ...
 \vect{c} \sim & \mathcal{M}(N, \boldsymbol{\alpha})
\end{align*}
$$ 
...
-   $\vect{s}$ est une **moyenne robuste** des proportions empirique $\vect{c}_i/N$
-   $A$ est un **facteur d'échelle** à choisir parmi $D$, $\sqrt{N}$, $g(\vect{s})$.
:::
::::
